...
exports.createPreviewModal = void 0;
const phaseFlags = {
    opened: false,
    hasHtml: false,
    logged: false
...
const ensurePreviewStyles = () => {
    if (document.getElementById("leditor-preview-styles"))
        return;
...
const createPreviewModal = (editorHandle) => {
    ensurePreviewStyles();
...
exports.createPreviewModal = createPreviewModal;
