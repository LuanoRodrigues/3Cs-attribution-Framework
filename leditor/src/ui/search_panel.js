...
exports.createSearchPanel = void 0;
const search_js_1 = require("../editor/search.js");
const ensureSearchStyles = () => {
    if (document.getElementById("leditor-search-styles"))
        return;
...
const createSearchPanel = (editorHandle) => {
    ensureSearchStyles();
    ...
    const applyQuery = () => {
        (0, search_js_1.setQuery)(searchInput.value);
    };
    ...
    controller = {
        open() {
            ...
            (0, search_js_1.markSearchPanelOpened)();
            applyQuery();
            searchInput.focus();
        },
        close() {
            panel.style.display = "none";
            (0, search_js_1.clearSearch)();
        },
        toggle() {
