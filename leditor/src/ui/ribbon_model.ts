...
const menuItem = (
  ...
  label,
  ...(extras ?? {}),
  command: args ? { id: commandId, args } : { id: commandId }
});
      ...
      "clusters": [
        {
          ...
          "controls": [
            ...
            },
            {
              ...
              "menu": [
                menuItem(
                  "pageSetup.columns.one",
                  "One",
                  "SetSectionColumns",
                  { count: 1 },
                  { description: "Single column layout.", shortcut: "Ctrl+Alt+1" }
                ),
                menuItem(
                  "pageSetup.columns.two",
                  "Two",
                  "SetSectionColumns",
                  { count: 2 },
                  { description: "Two equal columns.", shortcut: "Ctrl+Alt+2" }
                ),
                menuItem(
                  "pageSetup.columns.three",
                  "Three",
                  "SetSectionColumns",
                  { count: 3 },
                  { description: "Three equal columns.", shortcut: "Ctrl+Alt+3" }
                ),
                menuItem(
                  "pageSetup.columns.four",
                  "Four",
                  "SetSectionColumns",
                  { count: 4 },
                  { description: "Four equal columns.", shortcut: "Ctrl+Alt+4" }
                ),
                {
                  "type": "separator"
                },
                menuItem("pageSetup.columns.more", "More Columns…", "pageSetup.columns.openDialog")
              ],
              "collapse": {
                "A": "visible",
                "B": "iconOnly",
          ...
          "controls": [
            {
              ...
              "menu": [
                ...
                {
                  "type": "menuItem",
                  "controlId": "cite.insertCitation.manager",
                  "label": "Reference Manager…",
                  "description": "Browse sources and quick insert.",
                  "shortcut": "Ctrl+Alt+Shift+K",
                  "command": {
                    "id": "citation.manager.openDialog"
                  }
                },
                {
                  "type": "menuItem",
...
export const aiTab = {
  ...
  "groups": [
    ...
    },
    {
      ...
      "clusters": [
        {
          "clusterId": "views.primary",
          "layout": "row",
          "controls": [
            {
              "controlId": "views.chat",
              "label": "Chat",
              "type": "button",
              "size": "small",
              "iconKey": "icon.commentAdd",
            ...
            {
              "controlId": "views.sources",
              "label": "Sources",
              "type": "button",
              "size": "small",
              "iconKey": "icon.citation",
              "command": {
                "id": "agent.view.open",
                "args": {
                  "view": "sources"
    ...
    {
      "groupId": "quickActions",
      "label": "Quick Actions",
      "priority": 95,
      "dialogLauncher": null,
      "clusters": [
        {
          "clusterId": "quickActions.row1",
          "layout": "row",
          "controls": [
            {
              "controlId": "quick.refine",
              "label": "Refine",
              "type": "button",
              "size": "medium",
              "iconKey": "icon.aiAssistant",
        ...
        {
          "clusterId": "quickActions.row2",
          "layout": "row",
          "controls": [
            {
              "controlId": "quick.shorten",
              "label": "Shorten",
              "type": "button",
              "size": "medium",
              "iconKey": "icon.shrinkFont",
    ...
    },
    {
      ...
      "clusters": [
        {
          "clusterId": "sections.batch",
          "layout": "row",
          "controls": [
            {
              "controlId": "sections.runAll",
              "label": "Draft All",
              "type": "button",
              "size": "medium",
              "iconKey": "icon.addText",
              "command": {
                "id": "agent.sections.runAll"
              },
              "collapse": {
                "A": {
                  "mode": "full"
        ...
        {
          "clusterId": "sections.row1",
          "layout": "row",
          "controls": [
            {
              "controlId": "sections.abstract",
              "label": "Abstract",
              "type": "button",
              "size": "small",
              "iconKey": "icon.paragraphStyle",
            ...
            {
              "controlId": "sections.introduction",
              "label": "Introduction",
              "type": "button",
              "size": "small",
              "iconKey": "icon.paragraphStyle",
            ...
            {
              "controlId": "sections.methodology",
              "label": "Methodology",
              "type": "button",
              "size": "small",
              "iconKey": "icon.paragraphStyle",
        ...
        {
          "clusterId": "sections.row2",
          "layout": "row",
          "controls": [
            {
              "controlId": "sections.findings",
              "label": "Findings",
              "type": "button",
              "size": "small",
              "iconKey": "icon.paragraphStyle",
            ...
            {
              "controlId": "sections.recommendations",
    ...
    },
    {
      ...
      "clusters": [
        {
          "clusterId": "dictionary.primary",
          "layout": "row",
          "controls": [
            {
              "controlId": "dictionary.define",
              "label": "Define",
              "type": "button",
              "size": "small",
              "iconKey": "icon.bookOpen",
    ...
    },
    {
      ...
      "clusters": [
        {
          "clusterId": "evidence.primary",
          "layout": "row",
          "controls": [
            {
              "controlId": "evidence.substantiate",
              "label": "Substantiate",
              "type": "button",
              "size": "medium",
              "iconKey": "icon.smartLookup",
            ...
            {
              "controlId": "evidence.checkSources",
              "label": "Check Sources",
              "type": "button",
              "size": "medium",
              "iconKey": "icon.citation",
            ...
            {
              "controlId": "evidence.clearChecks",
              "label": "Clear Checks",
              "type": "button",
              "size": "medium",
              "iconKey": "icon.clear",
