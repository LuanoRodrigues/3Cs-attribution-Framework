...
const layoutPlan = {
  ...
  "assumptions": [
    "Ribbon model and tab registry are complete and valid; missing required fields must throw.",
  ...
  "stateContract": {
    "kinds": {
      ...
      "mixed": {
        "represents": "multiple selections with differing values"
      },
      "enum": {
        "represents": "string enum constrained by control config"
      },
      "number": {
      ...
      "color": {
        "represents": "CSS color string or null"
      },
      "list": {
        "represents": "array of entries for galleries/menus"
      }
    },
    "bindingRules": [
  ...
  "rollback": {
    ...
    "configRollback": [
      "Revert ribbon_model.ts and layout_plan.ts to last known-good versions."
    ]
  },
  "deliverables": [
    "layout_plan.md",
